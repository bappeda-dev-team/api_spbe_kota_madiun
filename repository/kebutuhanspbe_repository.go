...
type KebutuhanSPBERepository interface {
	...
	DeleteKeteranganKebutuhan(ctx context.Context, tx *sql.Tx, kebutuhanSPBEId int) error
	...
	FindIdForPetarencana(ctx context.Context, tx *sql.Tx, kebutuhanId int, pj string, kodeOPD string) (domain.KebutuhanSPBE, error)
}
