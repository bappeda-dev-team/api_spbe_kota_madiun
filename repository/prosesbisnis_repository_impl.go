...
func (repository *ProsesBisnisRepositoryImpl) FindByKodeOpd(ctx context.Context, tx *sql.Tx, kodeOPD string, tahun int) ([]domain.ProsesBisnis, error) {
	script := "SELECT id, nama_proses_bisnis, sasaran_kota_id, kode_proses_bisnis, kode_opd, bidang_urusan, rab_level_1_id, rab_level_2_id, rab_level_3_id, rab_level_4_id, rab_level_5_id, rab_level_6_id, tahun, created_at, updated_at FROM proses_bisnis WHERE 1=1"
	var args []interface{}
...
func (repository *ProsesBisnisRepositoryImpl) FindById(ctx context.Context, tx *sql.Tx, prosesbisnisId int) (domain.ProsesBisnis, error) {
	script := "select id, nama_proses_bisnis, sasaran_kota_id, kode_proses_bisnis, kode_opd, bidang_urusan, rab_level_1_id, rab_level_2_id, rab_level_3_id, tahun, created_at, updated_at from proses_bisnis where id = ?"
...
func (repository *ProsesBisnisRepositoryImpl) Insert(ctx context.Context, tx *sql.Tx, prosesBisnis domain.ProsesBisnis) domain.ProsesBisnis {
	...
	script := "insert into proses_bisnis (nama_proses_bisnis, sasaran_kota_id, kode_proses_bisnis, kode_opd, bidang_urusan, rab_level_1_id, rab_level_2_id, rab_level_3_id, rab_level_4_id, rab_level_5_id, rab_level_6_id, tahun, created_at, updated_at) values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?)"
...
func (repository *ProsesBisnisRepositoryImpl) Update(ctx context.Context, tx *sql.Tx, prosesBisnis domain.ProsesBisnis) domain.ProsesBisnis {
	...
	script := "update proses_bisnis set nama_proses_bisnis = ?, sasaran_kota_id = ?, kode_proses_bisnis = ?, kode_opd = ?, bidang_urusan = ?, rab_level_1_id = ?, rab_level_2_id = ?, rab_level_3_id = ?, rab_level_4_id = ?, rab_level_5_id = ?, rab_level_6_id = ?, tahun = ?, updated_at = ? where id = ?"
