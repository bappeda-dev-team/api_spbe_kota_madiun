...
func NewDataDanInformasiRepositoryImpl() *DataDanInformasiRepositoryImpl {
...
func (repository *DataDanInformasiRepositoryImpl) FindByKodeOpd(ctx context.Context, tx *sql.Tx, kodeOPD string, tahun int) ([]domain.DataDanInformasi, error) {
	script := "SELECT id, nama_data, sifat_data, jenis_data, produsen_data, uraian_data, validitas_data, pj_data, informasi_terkait_input,informasi_terkait_output,interoprabilitas, keterangan, kode_opd, tahun, created_at, updated_at, rad_level_1_id, rad_level_2_id, rad_level_3_id, rad_level_4_id, strategic_id, tactical_id, operational_id FROM data_dan_informasi WHERE 1=1"
	var args []interface{}
...
func (repository *DataDanInformasiRepositoryImpl) FindById(ctx context.Context, tx *sql.Tx, dataId int) (domain.DataDanInformasi, error) {
	script := "SELECT id, nama_data, sifat_data, jenis_data, produsen_data, uraian_data, validitas_data, pj_data, informasi_terkait_input,informasi_terkait_output,interoprabilitas, keterangan, kode_opd, tahun,created_at, updated_at, rad_level_1_id, rad_level_2_id, rad_level_3_id, rad_level_4_id, strategic_id, tactical_id, operational_id FROM data_dan_informasi WHERE id =?"
...
func (repository *DataDanInformasiRepositoryImpl) Insert(ctx context.Context, tx *sql.Tx, datainformasi domain.DataDanInformasi) domain.DataDanInformasi {
	...
	script := "INSERT INTO data_dan_informasi (nama_data, sifat_data, jenis_data, produsen_data, uraian_data, validitas_data, pj_data, informasi_terkait_input,informasi_terkait_output,interoprabilitas, keterangan, kode_opd, tahun, created_at, updated_at, rad_level_1_id, rad_level_2_id, rad_level_3_id, rad_level_4_id, strategic_id, tactical_id, operational_id ) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
...
func (repository *DataDanInformasiRepositoryImpl) Update(ctx context.Context, tx *sql.Tx, datainformasi domain.DataDanInformasi) domain.DataDanInformasi {
	...
	script := "UPDATE data_dan_informasi SET nama_data = ?, sifat_data = ?, jenis_data = ?, produsen_data = ?, uraian_data = ?, validitas_data = ?,pj_data = ?, informasi_terkait_input = ?, informasi_terkait_output = ?, interoprabilitas = ?, keterangan = ?, kode_opd = ?, tahun = ?, updated_at = ?, rad_level_1_id = ?, rad_level_2_id = ?, rad_level_3_id = ?, 	rad_level_4_id = ?, strategic_id = ?, tactical_id = ?, operational_id = ?	WHERE id = ?"
