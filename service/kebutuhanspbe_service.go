...
type KebutuhanSPBEService interface {
	...
	DeleteKeteranganKebutuhan(ctx context.Context, kebutuhanSPBEId int, kodeOpd string, role string) error
	...
	FindPenanggungJawab(ctx context.Context, pj string, tahun int) ([]web.PjKebutuhanSPBEResponse, error)
