...
func NewProsesBisnisService(referensiarsitekturRepository repository.ReferensiArsitekturRepository, prosesbisnisRepository repository.ProsesBisnisRepository, DB *sql.DB, validate *validator.Validate) ProsesBisnisService {
